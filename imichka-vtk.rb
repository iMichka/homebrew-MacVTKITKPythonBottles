...
class ImichkaVtk < Formula
  ...
  bottle do
    ...
    revision 5
    sha1 '913dee9d683c780b42a535eea2bd0a1027b3e89d' => :yosemite
    sha1 '08a317e9a7ef387dcd8bfbb0753c47a4484d3945' => :mavericks
    sha1 '981c024dcf17e57d754c6ff1582a9d581a95354c' => :mountain_lion
  end
